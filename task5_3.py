...
class Panel:
    ...
    def __init__(self, peds, obstacles, target, rMax):
        ...
        for ped in peds:
            self.drawRec(ped[0], ped[1], "P", 255)

        self.drawRec(target[0], target[1], "T", (0,0,255,0) )
    ...
    def moveRect(self, X_new, Y_new, X_old, Y_old, velocity):
    ...
    def moveUpdated(self,p,tCord,peds, velocity):
        ...
        if minD != 0:
            if minD == d1:
                ...
                ans[1]=pY+1
        self.moveRect(ans[0],ans[1],pX,pY, velocity)
        return ans
    ...
    def updateState(self, peds , numStep):
        ...
        for i in range(1,numStep+1):
            ...
            for j in range(0, len(peds)):
                ...
                # print(len(peds))
                if i % peds[j][2]==0:
                    peds[j] = self.moveUpdated(peds[j],self.target,peds, peds[j][2])
...
peds = [[1, 10, 2],[1, 8, 1], [1, 20, 4]]
# peds = [[1, 1], [1, 5]]
target = [13, 13]
obstacles = [[9, 8], [10, 8], [11, 8], [11, 9], [11, 10], [11, 11] , [11, 12], [11, 13], [11, 14], [11, 15], [11, 16],[10, 16], [9, 16], [8, 16], [8, 20], [9, 20], [10, 20], [11, 20], [12, 20 ], [13, 20], [14, 20], [15, 20],[15, 19],[15, 18],[15, 17],[15, 16],[15, 15],[15, 14],[15, 13],[15, 12],[15, 11],[15, 10],[15, 9],[15, 8],[15, 7],[15, 6],[14, 6],[13, 6],[12, 6],[11, 6],[10, 6],[9, 6]]
